...
Arrhenatherum_elatius <- BIEN_occurrence_species(species = "Arrhenatherum elatius",
                                                ...
                                                observation.type = TRUE,
                                                political.boundaries = TRUE)
Artemisia_scopulorum <- BIEN_occurrence_species(species = "Artemisia scopulorum",
                                                 cultivated = TRUE,
                                                 all.taxonomy = TRUE,
                                                 native.status = TRUE,
                                                 observation.type = TRUE,
...
Danthonia_spicata <- BIEN_occurrence_species(species = "Danthonia spicata",
                                         ...
                                         observation.type = TRUE,
                                         political.boundaries = TRUE)
Deschampsia_cespitosa <- BIEN_occurrence_species(species = "Deschampsia cespitosa",
                                             cultivated = TRUE,
                                             all.taxonomy = TRUE,
                                             native.status = TRUE,
                                             observation.type = TRUE,
...
Fragaria_vesca <- BIEN_occurrence_species(species = "Fragaria vesca",
                                                 ...
                                                 observation.type = TRUE,
                                                 political.boundaries = TRUE)
Geum_rossii<- BIEN_occurrence_species(species = "Geum rossii",
                                          cultivated = TRUE,
                                          all.taxonomy = TRUE,
                                          native.status = TRUE,
                                          observation.type = TRUE,
...
Taraxacum_officinale <- BIEN_occurrence_species(species = "Taraxacum officinale",
                                                 ...
                                                 observation.type = TRUE,
                                                 political.boundaries = TRUE)
Trifolium_andersonii <- BIEN_occurrence_species(species = "Trifolium andersonii",
                                                cultivated = TRUE,
                                                all.taxonomy = TRUE,
                                                native.status = TRUE,
                                                observation.type = TRUE,
