## TITLE:         OTC Meta Analysis PDF analysis  -using trycatch
## AUTHOR:        P. Zarnetske 
...
## with this method, using HPCC, no output because "priority column" cannot be found
## tryCatch may not be passing the info inside the function to the environment
